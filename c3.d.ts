...
interface IRuntimeObjects {
	...
	['staticTitles3']: IObjectClass<IstaticTitles3>;
	['staticTitles2']: IObjectClass<IstaticTitles2>;
	['staticTitles']: IObjectClass<IstaticTitles>;
	['startButton']: IObjectClass<IstartButton>;
	['settingInput']: IObjectClass<IsettingInput>;
	['seedText']: IObjectClass<IseedText>;
	['randomizeButton']: IObjectClass<IrandomizeButton>;
	['particle']: IObjectClass<Iparticle>;
	['numberInput3']: IObjectClass<InumberInput3>;
	['numberInput']: IObjectClass<InumberInput>;
	['Mouse']: IObjectClass<IMouse>;
	['loadButton']: IObjectClass<IloadButton>;
	['Keyboard']: IObjectClass<IKeyboard>;
	['helperText']: IObjectClass<IhelperText>;
	['generateButton']: IObjectClass<IgenerateButton>;
	['Gamepad']: IObjectClass<IGamepad>;
	['FPSText']: IObjectClass<IFPSText>;
	['copyButton']: IObjectClass<IcopyButton>;
	['Clipboard']: IObjectClass<IClipboard>;
	['Browser']: IObjectClass<IBrowser>;
	['bg']: IObjectClass<Ibg>;
	['attractionText']: IObjectClass<IattractionText>;
	['attractionSlider']: IObjectClass<IattractionSlider>;
}
...
interface IstaticTitles3Vars extends VariableType {
	
}
interface IstaticTitles3Behaviors extends Record<string, IBehaviorInstance> {
	
}
interface IstaticTitles3 extends ITextInstance {
	instVars: IstaticTitles3Vars;
	behaviors: IstaticTitles3Behaviors;
}

interface IstaticTitles2Vars extends VariableType {
	
}
interface IstaticTitles2Behaviors extends Record<string, IBehaviorInstance> {
	
}
interface IstaticTitles2 extends ITextInstance {
	instVars: IstaticTitles2Vars;
	behaviors: IstaticTitles2Behaviors;
}

interface IstaticTitlesVars extends VariableType {
	
}
interface IstaticTitlesBehaviors extends Record<string, IBehaviorInstance> {
	
}
interface IstaticTitles extends ITextInstance {
	instVars: IstaticTitlesVars;
	behaviors: IstaticTitlesBehaviors;
}
...
interface IstartButton extends IButtonInstance {
	instVars: IstartButtonVars;
	behaviors: IstartButtonBehaviors;
}

interface IsettingInputVars extends VariableType {
	/**  **/
	['setting']: string;
}
interface IsettingInputBehaviors extends Record<string, IBehaviorInstance> {
	
}
interface IsettingInput extends IWorldInstance {
	instVars: IsettingInputVars;
	behaviors: IsettingInputBehaviors;
}

interface IseedTextVars extends VariableType {
	/**  **/
	['setting']: string;
}
interface IseedTextBehaviors extends Record<string, IBehaviorInstance> {
	
}
interface IseedText extends IWorldInstance {
	instVars: IseedTextVars;
	behaviors: IseedTextBehaviors;
}

interface IrandomizeButtonVars extends VariableType {
	
}
interface IrandomizeButtonBehaviors extends Record<string, IBehaviorInstance> {
	
}
interface IrandomizeButton extends IButtonInstance {
	instVars: IrandomizeButtonVars;
	behaviors: IrandomizeButtonBehaviors;
}

interface IparticleVars extends VariableType {
	
}
interface IparticleBehaviors extends Record<string, IBehaviorInstance> {
	
}
interface Iparticle extends ISpriteInstance {
	instVars: IparticleVars;
	behaviors: IparticleBehaviors;
}

interface InumberInput3Vars extends VariableType {
	/**  **/
	['color']: string;
}
interface InumberInput3Behaviors extends Record<string, IBehaviorInstance> {
	
}
interface InumberInput3 extends IWorldInstance {
	instVars: InumberInput3Vars;
	behaviors: InumberInput3Behaviors;
}

interface InumberInputVars extends VariableType {
	/**  **/
	['color']: string;
}
interface InumberInputBehaviors extends Record<string, IBehaviorInstance> {
	
}
interface InumberInput extends IWorldInstance {
	instVars: InumberInputVars;
	behaviors: InumberInputBehaviors;
}
...
interface IloadButtonVars extends VariableType {
	
}
interface IloadButtonBehaviors extends Record<string, IBehaviorInstance> {
	
}
interface IloadButton extends IButtonInstance {
	instVars: IloadButtonVars;
	behaviors: IloadButtonBehaviors;
}
...
interface IhelperTextVars extends VariableType {
	
}
interface IhelperTextBehaviors extends Record<string, IBehaviorInstance> {
	
}
interface IhelperText extends ITextInstance {
	instVars: IhelperTextVars;
	behaviors: IhelperTextBehaviors;
}

interface IgenerateButtonVars extends VariableType {
	
}
interface IgenerateButtonBehaviors extends Record<string, IBehaviorInstance> {
	
}
interface IgenerateButton extends IButtonInstance {
	instVars: IgenerateButtonVars;
	behaviors: IgenerateButtonBehaviors;
}
...
interface IGamepad extends IWorldInstance {
	instVars: IGamepadVars;
	behaviors: IGamepadBehaviors;
}

interface IFPSTextVars extends VariableType {
	
}
interface IFPSTextBehaviors extends Record<string, IBehaviorInstance> {
	
}
interface IFPSText extends ITextInstance {
	instVars: IFPSTextVars;
	behaviors: IFPSTextBehaviors;
}

interface IcopyButtonVars extends VariableType {
	
}
interface IcopyButtonBehaviors extends Record<string, IBehaviorInstance> {
	
}
interface IcopyButton extends IButtonInstance {
	instVars: IcopyButtonVars;
	behaviors: IcopyButtonBehaviors;
}

interface IClipboardVars extends VariableType {
	
}
interface IClipboardBehaviors extends Record<string, IBehaviorInstance> {
	
}
interface IClipboard extends IWorldInstance {
	instVars: IClipboardVars;
	behaviors: IClipboardBehaviors;
}
...
interface IbgVars extends VariableType {
	
}
interface IbgBehaviors extends Record<string, IBehaviorInstance> {
	
}
interface Ibg extends ISpriteInstance {
	instVars: IbgVars;
	behaviors: IbgBehaviors;
}

interface IattractionTextVars extends VariableType {
	/**  **/
	['index']: number;
}
interface IattractionTextBehaviors extends Record<string, IBehaviorInstance> {
	
}
interface IattractionText extends ITextInstance {
	instVars: IattractionTextVars;
	behaviors: IattractionTextBehaviors;
}

interface IattractionSliderVars extends VariableType {
	/**  **/
	['index']: number;
}
interface IattractionSliderBehaviors extends Record<string, IBehaviorInstance> {
	
}
interface IattractionSlider extends IWorldInstance {
	instVars: IattractionSliderVars;
	behaviors: IattractionSliderBehaviors;
}
